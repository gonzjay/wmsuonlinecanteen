...
def customer_page():
    ...
    return render_template("Customer/customer_page.html",record=record,customer=customer, carts=carts,foodlist=foodlist)
...
def cart():
    ...
    try:
       ...
       if check==1: 
           ...
           add_cart = Cart(customer.id, food.food_name,food.image_url, vendor.store_name , request.form['food_quantity'], food.price,total,date)    
